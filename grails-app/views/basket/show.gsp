...
<html>
    ...
    <body>
        ...
        <div id="show-basket" class="content scaffold-show" role="main">
            ...
            <f:display bean="basket" />
            <g:form resource="${this.basket}" method="DELETE">
                <fieldset class="buttons">
                    <g:link class="edit" action="edit" resource="${this.basket}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
